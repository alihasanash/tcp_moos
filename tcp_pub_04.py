                ...
                with conn, conn.makefile('r') as client_file:
                    for line in client_file:
                        try:
                            ...
                            sent = False
                            for k in ("NAV_INFO", "MAP_INFO", "WAYPT_NAV", "WAYPT_NEXT", "AREA_NAV", "OWNSHIP_OOB"):
                                if k in json_data:
                                    if k != "NAV_INFO" and k != "MAP_INFO":
                            ...
                            print("DATA SENT!")
                            if not sent:
                                print("No NAV_INFO, MAP_INFO, WAYPT_NAV, WAYPT_NEXT, AREA_NAV, OR OWNSHIP_OOB found in JSON")
